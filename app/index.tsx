...
const discovery = {
  ...
  revocationEndpoint: 'https://github.com/settings/connections/applications/e82899440978e20e4634',
};
...
export default function App() {
  ...
  return (
    <View className='flex-1 items-center px-8 py-10'>     
      ...
      <Text className='text-center font-body text-sm leading-relaxed text-gray-200'>Developed by Roberto Junior and licensed by Rocketseat</Text>
    </View>
  );
}
